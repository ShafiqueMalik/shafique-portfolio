...
import { FaLaptopCode, FaReact, FaWordpress, FaServer, FaMapMarkedAlt } from 'react-icons/fa';
...
export const ProjectCategories = ['All', 'ReactJS', 'Responsive', 'Design', 'HTML5/CSS3', 'NodeJS'];
...
export const servicesData = [
  ...
  },
  {
    ...
    icon: FaReact,
    description: 'Building dynamic and modern web applications with React and Next.js.',
  },
  {
  ...
  },
  {
    ...
    icon: FaMapMarkedAlt,
    description: 'Integrating and customizing Google Maps using the JavaScript API.',
  },
];
