  ...
  return (
    <section id="contact-section" className=" scroll-mt-[64px] py-12 ">
      <Container className=" " sm>
        ...
        <div className="grid border-2 rounded-3xl lg:rounded-none grid-cols-1 md:grid-cols-[1fr_1fr] lg:rounded-tr-[80px] lg:rounded-bl-[80px]  overflow-hidden">
          <div className=" bg-primary/10 px-5 md:px-10 py-10">
            <h3 className="text-2xl font-medium">Send Me A Message</h3>
            <ContactForm />
          </div>
          <div className="bg-primary text-white  px-5 md:px-10 py-10">
