...
const PortfolioSection = () => {
  return (
    <section
      ...
      className=" scroll-mt-[64px] py-12 bg-background-light"
    >
      <Container className=" " sm>
        ...
        <ul className="flex flex-wrap justify-center gap-y-2 gap-5 md:gap-8 mb-10 items-center">
          {ProjectCategories.map((category, idx) => (
            ...
            >
              <button
                className={`px-3 py-1 border-primary border disabled:opacity-30 ${
                  idx === 0 ? "text-secondary border-secondary" : ""
                }`}
                disabled={idx !== 0}
        ...
        <div className="grid grid-cols-1 mob-lg:grid-cols-2 md:grid-cols-3 gap-5 md:gap-10 ">
