...
const MySkillsSection = () => {
  return (
    <section id="skills-section" className=" scroll-mt-[64px] py-12 bg-white dark:bg-dark">
      <Container className=" ">
        <p className="text-primary-light text-center dark:text-dark-text-light">Why Choose Me</p>
        ...
        <div className="grid grid-cols-1 mob-lg:grid-cols-[1fr_1px_1fr] gap-5 lg:gap-20 ">
          <div>
            <h4 className="text-xl font-medium lg:text-3xl text-center mb-5">FRONT-END SKILLS</h4>
            <ul className="grid grid-cols-1  md:grid-cols-2 gap-3 md:gap-6 justify-between">
              {frontEndMainskillsData.map((skill) => (
                <li key={skill.skill}>
