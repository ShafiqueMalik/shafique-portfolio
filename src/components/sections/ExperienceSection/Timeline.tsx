          ...
          <div key={event.title} className="">
            <div className="flex flex-row items-start ">
              <div className="flex flex-col self-stretch">
                <div className="flex-shrink-0 bg-primary text-white dark:text-dark dark:bg-white rounded-full translate-y-[2px] h-4 w-4 flex items-center justify-center">
                  <span className=" font-medium text-[8px]">{index + 1}</span>
                </div>
                <div className="w-[2px] relative left-[7px] top-[2px] bg-primary dark:bg-dark-text-light h-full flex-1" />
              </div>
              <div className="ml-4">
